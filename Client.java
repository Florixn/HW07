...
public static void main(String[] args) {
        ...
        CalculatingCosts C=new CalculatingCosts();
        microwaveOven.accept(C);
        tv.accept(C);
        wineGlass.accept(C);
        coffeeTable.accept(C);
        bed.accept(C);
        cupboard.accept(C);
        
//        PackingInstructions P=new PackingInstructions();
//        microwaveOven.accept(P);
//        tv.accept(P);
//        wineGlass.accept(P);
//        coffeeTable.accept(P);
//        bed.accept(P);
//        cupboard.accept(P);
